...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/bhathika-gimhan/.vscode/extensions/wallabyjs.console-ninja-1.0.361/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20ced2f95f03efed842175VktdBkgJD1RTUgFSXVwADFBTVFcH', mode: 'build'}); } catch(cjsError) { try { import('file:///home/bhathika-gimhan/.vscode/extensions/wallabyjs.console-ninja-1.0.361/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20ced2f95f03efed842175VktdBkgJD1RTUgFSXVwADFBTVFcH', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
